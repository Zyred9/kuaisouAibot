...
public class RedisHelper {
    ...
    public static void delete(Long userId) {
        String key = StrHelper.getKey(userId);
        RedisHelper.delete(String.valueOf(key));
    }
    ...
    public static Boolean hasKey(Long key) {
        return RedisHelper.hasKey(StrHelper.getKey(key));
    }
    ...
    public static void set(Long userId, String value) {
        redisTemplate.opsForValue().set(StrHelper.getKey(userId), value);
    }
    ...
    public static String hGet(String key, Long userId) {
    ...
    public static void put(String key, Long field, String value) {
        put(key, String.valueOf(field), value);
    }
     ...
     * @param maps 字段-值
     */
    public static void putAll(String key, Map<String, String> maps) {
        redisTemplate.opsForHash().putAll(key, maps);
    }

//    public static void putAll(String key, Map<Long, String> maps) {
//        redisTemplate.opsForHash().putAll(key, maps);
//    }
     ...
     * @return 是否成功
     */
    public static Boolean hPutIfAbsent(String key, String field, String value) {
     ...
     * @return 删除个数
     */
    public static Long delete(String key, Object... fields) {
    ...
    public static Boolean exists(String key, Long field) {
        return redisTemplate.opsForHash().hasKey(key, String.valueOf(field));
    }
